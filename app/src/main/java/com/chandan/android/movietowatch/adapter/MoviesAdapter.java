...
import com.chandan.android.movietowatch.DetailActivity;
...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MoviesAdapter.MyViewHolder viewHolder, int i){
        ...
        String voteCount = Integer.toString(movieList.get(i).getVoteCount());
        viewHolder.voteCountText.setText("("+voteCount+")");
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        public TextView title, userrating,voteCountText;
        ...
        public MyViewHolder(View view){
            ...
            voteCountText = (TextView)view.findViewById(R.id.vote_count);
